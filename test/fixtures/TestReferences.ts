...
import { BundleBackendFactory } from '../../src/build/BundleBackendFactory';
import { BundleBackendServiceFactory } from '../../src/build/BundleBackendServiceFactory';

export class TestReferences extends ManagedReferences {
    private _factory = new BundleBackendFactory();
