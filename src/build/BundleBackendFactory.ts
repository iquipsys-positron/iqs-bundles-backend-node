...
import { BundleBackendServiceFactory } from './BundleBackendServiceFactory';

export class BundleBackendFactory extends DefaultContainerFactory {
    ...
    public constructor() {
        ...
        this.add(new BundleBackendServiceFactory());
